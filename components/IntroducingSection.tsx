    ...
    <div className="py-20 pt-24 bg-gradient-to-l from-white to-blue-600">
      <div className="text-center flex flex-col gap-y-5 items-center">
        <h2 className="text-white text-8xl font-extrabold text-center mb-2 max-md:text-6xl max-[480px]:text-4xl">
          INTRODUCING <span className="text-black">MENS</span><span className="text-blue-600">FYT</span>
        </h2>
        <div>
          <p className="text-blue text-center text-2xl font-semibold max-md:text-xl max-[480px]:text-base">
          MensFyt was founded with the mission to provide high-quality, stylish, and comfortable clothing tailored for men.
          We believe that clothing should not only look great but also feel great.
          </p>
          <p className="text-blue text-center text-2xl font-semibold max-md:text-xl max-[480px]:text-base">
          Our team is dedicated to bringing the latest
          trends and timeless styles together.
          </p>
